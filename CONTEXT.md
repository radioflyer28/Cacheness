...
**Catalog attributes**:
Application-defined metadata belonging to the authoritative blob description. They are distinct from external links or indexes derived from that description.

**Derived metadata outcome**:
The outcome of updating an external link or index after a blob commits. Failure of that update is not failure or rollback of the blob commit.
