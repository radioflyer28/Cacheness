...
**Plans**: 17/17 canonical plans complete; 08-11 and 08-12 superseded by D-24/SEED-007. Awaiting independent phase verification.
...
- [x] 09-01-PLAN.md — Atomically cut the protocol, both storage barrels, error hierarchy, and importing tests to FormatHandler.
...
- [x] 09-04-PLAN.md — Delete the first bounded obsolete non-SqlCache example batch.
- [x] 09-05-PLAN.md — Delete the second bounded obsolete/remote-promoting example batch.

**Wave 4** *(blocked on package/examples and cleanup)*

- [x] 09-06-PLAN.md — Bind exact published examples to CI and remove the superseded harness/final duplicates.
- [x] 09-07-PLAN.md — Replace stale onboarding with a concise gateway and task-first current workflow guides.

**Wave 5** *(blocked on current onboarding)*

- [x] 09-08-PLAN.md — Consolidate security, bounds, topology, and qualification claims into one tested owner.

**Wave 6** *(blocked on qualification/security claims)*

- [x] 09-09-PLAN.md — Publish the current API/FormatHandler tutorial and delete obsolete document branches.

**Wave 7** *(blocked on CI and complete docs)*

- [x] 09-10-PLAN.md — Refresh Phase 3/8 evidence metadata, capture the Narwhals seed, and run final bounded gates.

**Wave 8** *(verification gap closure)*

- [x] 09-11-PLAN.md — Correct stale qualification ownership in the migration guide and guard it with a focused documentation contract.
...
- [x] 11-03-PLAN.md — Remove TensorFlow runtime/config/export/package/lock/packaging surfaces.
- [x] 11-05-PLAN.md — Consolidate verified supplemental guidance and delete stale guides.

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 11-04-PLAN.md — Remove TensorFlow-only qualification profiles and CI jobs.
...
- [x] 11-07-PLAN.md — Refresh current agent/codebase maps and fulfill SEED-005.

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 11-08-PLAN.md — Normalize Phase 1/5/6/7/8/9 validation records in place.
...
- [x] 11-10-PLAN.md — Refresh the milestone audit last with an evidence-derived verdict.

**Wave 9** *(gap closure; blocked on Wave 8 completion)*

- [x] 11-11-PLAN.md — Bind post-review acceptance evidence to the qualified source tree.

**Wave 10** *(blocked on Wave 9 completion)*

- [x] 11-12-PLAN.md — Re-derive the milestone audit from the qualified post-review evidence.
