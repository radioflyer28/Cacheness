...
| 30-04-01 | 04 | 3 | PAR-04 | T-30-05 | Integrity enumeration sees custom-extension orphan blobs while excluding reserved/temp files | integrity/regression | `uv run --python 3.12 pytest tests/test_cache_integrity_verification.py tests/test_blob_store.py -x -q --ignore=tests/test_tensorflow_handler.py` | ✅ | ⬜ pending |
