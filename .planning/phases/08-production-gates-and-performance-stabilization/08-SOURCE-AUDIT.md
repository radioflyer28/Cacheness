...
|---|---|---|---|---|---|
| GOAL | — | Reproducible release evidence across supported installations, Python versions, backends, failures, and operational scale | 01-11 | COVERED | Evidence tracer expands through isolated gates and converges on exact-release qualification. |
| REQ | BACK-05 | Real PostgreSQL and authoritative Amazon S3 integration qualification | 08, 10, 11 | COVERED | Runner/workflow are deterministic to validate locally; Plan 11 requires real service proof. |
...
| REQ | QUAL-03 | CI covers runtimes, contracts, quality, packaging, PostgreSQL, and AWS | 01-03, 05-11 | COVERED | Evidence classes use separate workflows and one final aggregator. |
...
| RESEARCH | R-01 | Evidence-class separation and exact-commit release manifest | 01, 10, 11 | COVERED | Common strict envelope and read-only aggregator. |
...
| RESEARCH | R-12 | Fixed final selector/source/decision/threat verifier | 10 | COVERED | Exact literal inventories and adversarial self-tests. |
| RESEARCH | R-13 | Release-lifetime qualifying evidence and bounded diagnostics | 08, 10, 11 | COVERED | QUALIFIED evidence attaches to release; diagnostics retain 30 days. |
...
| CONTEXT | D-10 | Live evidence qualifies exact release commit | 01, 08, 10, 11 | COVERED | Source digest and SHA checked at production and aggregation. |
| CONTEXT | D-11 | Unavailable/incomplete live evidence blocks release | 01, 08, 10, 11 | COVERED | No mock/skip/earlier-commit substitution. |
| CONTEXT | D-12 | Preserve frozen runner, exact cleanup, and S3 constraints | 08, 11 | COVERED | Explicit bucket/region and standard AWS only. |
| CONTEXT | D-13 | Lifetime QUALIFIED evidence; bounded diagnostics | 08, 10, 11 | COVERED | 30-day diagnostics and release attachment. |
...
| CONTEXT | D-20 | Controlled Linux distributions and reviewed envelope | 07, 10, 11 | COVERED | Actual baseline capture is prerequisite-gated. |
| CONTEXT | D-21 | Page/work complexity and backend-call formulas | 06, 09 | COVERED | Fixed tiers and independent call classes. |
| CONTEXT | D-22 | Controlled local performance blocks; remote latency diagnostic | 07, 08, 09, 10, 11 | COVERED | Workflow and release rules enforce separation. |
