...
|---|---|---|---|---|---|
| GOAL | — | Reproducible release evidence across supported installations, Python versions, backends, failures, and operational scale | 01-14 | COVERED | Evidence tracer expands through isolated gates, exact-run collection, explicit performance deferral, and verified immutable publication. |
...
| RESEARCH | R-12 | Fixed final selector/source/decision/threat verifier | 10, 14, 12 | COVERED | Exact literal inventories, adversarial self-tests, and final remote-state verification. |
...
All current-milestone GOAL, REQ, in-scope RESEARCH, and CONTEXT items are covered. QUAL-06/R-08 and the current release-blocking portions of D-20/D-22 are explicitly deferred by developer decision D-23 to SEED-006, not silently omitted.
