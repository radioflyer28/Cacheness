...
- [ ] 08-13-PLAN.md — Add the read-only exact-commit controlled-runner preflight required before baseline capture.
...
| 8. Production Gates and Performance Stabilization | 10/13 | In Progress|  |
