...
- [ ] 03-12-PLAN.md — Add a digest-bound contract distinguishing repository-runtime evidence from Python 3.11 native-qualification attestation
- [ ] 03-11-PLAN.md — Capture and attest the current host's UNAVAILABLE/NOT_QUALIFIED Windows evidence after the additive command contract closes
...
| 3. Atomic Lifecycle and Recovery Engine | 9/12 | In Progress|  |
