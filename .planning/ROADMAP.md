...
- [x] Phase 32: Small Fixes & Release Polish — independent low-risk fixes and release/version polish; final full-suite checkpoint passed (completed 2026-06-15)
...
- [x] 29-03-PLAN.md - TASK-7 access-count, created_at, TTL field, and signature preservation (TTL-03)
...
- [x] 31-01-PLAN.md - TASK-13 signature minimum version and unsigned-entry docs (SEC-01)
- [x] 31-05-PLAN.md - SEED-001 storage-mode destructive API warning policy (STRG-01)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 31-02-PLAN.md - TASK-14 encrypted backend-routed in-memory reads (SEC-02)
- [x] 31-07-PLAN.md - SEED-006 write intents before blob writes (STRG-03)

**Wave 3** *(blocked on 31-01 and 31-02)*

- [x] 31-04-PLAN.md - SEED-004 shared canonical signing with compatibility (SEC-04)

**Wave 4** *(blocked on 31-01, 31-02, and 31-04)*

- [x] 31-03-PLAN.md - TASK-15 two-phase key rotation (SEC-03)
