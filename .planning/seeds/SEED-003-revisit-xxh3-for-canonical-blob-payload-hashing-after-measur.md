...
- `.planning/milestones/v1.0-phases/05-payload-backends-and-supported-topology-qualification/05-CONTEXT.md` — decision D-10 makes SHA-256 plus byte size canonical and treats ETags as corroborating evidence only.
