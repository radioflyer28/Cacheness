...
def _serialize_for_hash(obj: Any) -> str:
    ...
    if obj is None:
        ...
        items = [f"{_serialize_for_hash(k)}:{_serialize_for_hash(v)}" 
...
def _generate_cache_key(func: Callable, args: Tuple, kwargs: Dict[str, Any], 
...
def cache_function(func: Optional[Callable] = None, **kwargs) -> Union[Callable, cached]:
    """
