...
try:
    from .config import load_config_from_yaml, save_config_to_yaml  # noqa: F401
...
try:
    from .storage import BlobStore  # noqa: F401
...
def register_handler(
    handler: CacheHandler, priority: int | None = None, name: str | None = None
) -> None:
    """
...
try:
    from .storage.backends import (  # noqa: F401
...
if _has_metadata_backends:
    __all__.extend(
        [
            ...
            "JsonMetadataBackend",
            "SQLiteMetadataBackend",  # Backward compatibility
        ]
    )
