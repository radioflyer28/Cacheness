...
class TestTensorFlowTensorHandler:
    ...
    @pytest.mark.skipif(SKIP_TENSORFLOW_TESTS, reason=TENSORFLOW_SKIP_REASON)
    ...
    def test_put_and_get_tensor(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            np.testing.assert_array_equal(
                loaded_tensor.numpy(), original_tensor.numpy()
            )
    ...
    def test_put_and_get_variable(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            np.testing.assert_array_equal(
                loaded_tensor.numpy(), original_variable.numpy()
            )
