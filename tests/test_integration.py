...
class TestCacheIntegration:
    ...
    def test_end_to_end_workflow(self, cache):
        ...
        for data_type, original_data in test_data.items():
            ...
            if isinstance(original_data, dict) and any(isinstance(v, np.ndarray) for v in original_data.values()):
                # Array dictionary
...
class TestCacheConfiguration:
    ...
    def test_different_configurations(self, temp_dir):
        ...
        configs = [
            ...
            CacheConfig(
                cache_dir=str(temp_dir / "config3"),
    ...
    def test_cache_directory_creation(self, temp_dir):
        ...
        config = CacheConfig(
            cache_dir=str(non_existent_dir),
            metadata_backend="json"
        )
