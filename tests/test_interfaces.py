...
class TestSpecializedHandlerInterfaces:
    ...
    def test_dataframe_handler(self):
        ...
        class TestDataFrameHandler(DataFrameHandler):
            ...
            def put(self, data: Any, file_path: Path, config: Any) -> Dict[str, Any]:
                return {"storage_format": "parquet", "file_size": 1000, "actual_path": str(file_path), "metadata": {}}
    ...
    def test_series_handler(self):
        ...
        class TestSeriesHandler(SeriesHandler):
            ...
            def put(self, data: Any, file_path: Path, config: Any) -> Dict[str, Any]:
                return {"storage_format": "pickle", "file_size": 500, "actual_path": str(file_path), "metadata": {}}
            ...
            def preserve_series_metadata(self, data: Any, metadata: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def test_array_handler(self):
        ...
        class TestArrayHandler(ArrayHandler):
            ...
            def put(self, data: Any, file_path: Path, config: Any) -> Dict[str, Any]:
                return {"storage_format": "npz", "file_size": 2000, "actual_path": str(file_path), "metadata": {}}
    ...
    def test_object_handler(self):
        ...
        class TestObjectHandler(ObjectHandler):
            ...
            def put(self, data: Any, file_path: Path, config: Any) -> Dict[str, Any]:
                return {"storage_format": "pickle", "file_size": 300, "actual_path": str(file_path), "metadata": {}}
