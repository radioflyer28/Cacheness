...
class TestMetadataIntegration:
    ...
    def test_metadata_storage_json(self, cache_json):
        ...
        cache_json.put(test_data, description="Test JSON metadata", test_key="json_test")
    ...
    def test_metadata_storage_sqlite(self, cache_sqlite):
        ...
        # Store some data
        test_data = {"test": "data", "numbers": [1, 2, 3]}
        cache_sqlite.put(test_data, description="Test SQLite metadata", test_key="sqlite_test")
    ...
    def test_cache_stats_integration(self, cache_json, cache_sqlite):
        ...
        for cache in [cache_json, cache_sqlite]:
            ...
            assert stats["total_size_mb"] >= 0  # Files exist but may be very small (0.000MB)
    ...
    def test_cleanup_integration(self, cache_json):
        ...
        # Store some data
        cache_json.put({"temp": "data"}, description="Temporary data", temp_key="cleanup_test")
    ...
    def test_backend_switching(self, temp_dir):
        ...
        json_cache.put({"backend": "json"}, description="JSON data", backend_test="json")
        ...
        sqlite_cache.put({"backend": "sqlite"}, description="SQLite data", backend_test="sqlite")
