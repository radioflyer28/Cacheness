...
from cacheness.interfaces import CacheHandler as CacheHandlerInterface
...
class TestRegisterHandler:
    ...
    def test_register_handler_negative_priority_becomes_zero(self, registry, mock_handler):
...
class TestListHandlers:
    ...
    def test_list_handlers_identifies_builtin(self, registry):
        ...
        builtin_names = {
            "polars_dataframe", "pandas_dataframe", "polars_series", 
            "pandas_series", "numpy_array", "object", "tensorflow_tensor"
        }
...
class TestHandlerSelection:
    ...
    def test_builtin_handler_selected_when_no_custom_match(self, registry, mock_handler):
...
class TestModuleLevelRegistration:
    ...
    def test_module_register_and_unregister(self):
        ...
        class UniqueTestHandler(CacheHandler):
            def can_handle(self, data): return False
            def put(self, data, file_path, config): return {}
            def get(self, file_path, metadata): return None
            def get_file_extension(self, config): return ".unique"
            @property
            def data_type(self): return "unique_test_handler_12345"
...
class TestHandlerValidation:
    ...
    def test_validates_can_handle_method(self, registry):
        ...
        class MissingCanHandle:
            def put(self, data, file_path, config): return {}
            def get(self, file_path, metadata): return None
            def get_file_extension(self, config): return ".test"
            @property
            def data_type(self): return "test"
...
class TestHandlerIntegration:
    ...
    def test_multiple_custom_handlers_priority(self, registry, mock_handler, another_handler):
