...
PHASE_DIRECTORY = PROJECT_ROOT / ".planning/milestones/v1.0-phases/07-explicit-migration-and-rebuild-cutover"
...
def _phase7_detector_scope() -> str:
    ...
    roadmap = (PROJECT_ROOT / ".planning/milestones/v1.0-ROADMAP.md").read_text(encoding="utf-8")
